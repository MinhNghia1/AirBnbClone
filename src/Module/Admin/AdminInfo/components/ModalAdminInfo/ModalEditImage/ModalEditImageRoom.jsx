...
import styled from "./ModalEditImageRoom.module.scss";
import { upLoadImgRoom } from "../../../../../../Apis/room";
...
export default function ModalEditImageRoom({ isOpen, onclose, idRoom, refreshPage }) {
  ...
  const handleEditImage = async (hinhAnh) => {
    try {
      setIsLoading(true);
      const resp = await upLoadImgRoom(idRoom, hinhAnh);
      onclose(false);
      if (resp) {
