...
export default function PersonalInfo({ getInfo }) {
  ...
  const getUser = async () => {
    try {
      const resp = await getUserId(param.IdUser);
      setInforUser(resp);
    } catch (error) {
      console.error(error);
    }
          ...
          <div className={styled.accountLeft}>
            <div className={styled.card}>
              <div className={styled.cardTop}>
                ...
                <p onClick={handleOnOpen}>Cập Nhật Ảnh</p>
              </div>
