            ...
            <div className="container">
                <div className="grid-item">
                    {rooms.map((room) => {
                        return (
                            <div>
                                <a href="" className='roomItem' key={room.id} onClick={() => navigate(`/roomDetail/${room.maPhim}`)}>
                                    ...
                                    <div className="btItem">
                                        <div className='container-bt'>
                                            ...
                                            <p class="price"><span class="number-price">${room.id + room.giaTien + 478}</span> đêm</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
