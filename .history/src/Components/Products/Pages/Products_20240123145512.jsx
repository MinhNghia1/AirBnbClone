...
export default function Products() {
  ...
  <div className="swiper-pagination swiper-pagination-bullets swiper-pagination-horizontal swiper-pagination-bullets-dynamic" style={{width: 80}}>
    <span className="swiper-pagination-bullet swiper-pagination-bullet-active swiper-pagination-bullet-active-main" style={{left: 16}}>
    </span>
    <span className="swiper-pagination-bullet swiper-pagination-bullet-active-next" style={{left: 16}}>
    </span>
    <span className="swiper-pagination-bullet swiper-pagination-bullet-active-next-next" style={{left: 16}}>
    </span>
  </div>
</div>
