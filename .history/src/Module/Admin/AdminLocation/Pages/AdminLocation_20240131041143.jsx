        ...
        <div style={{ width: "90%", marginTop: "100px" }}>
            ...
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead style={{ width: "90%", marginTop: "100px" }}>
                        <TableRow>
                    ...
                    <TableBody>
                        {(rowsPerPage > 0
                            ...
                            <TableRow key={location.id}>
                                ...
                                <TableCell>{location.tenViTri}</TableCell>
                                <TableCell>
                                    <img src={location.hinhAnh} width={50} height={50} alt="" />
                                </TableCell>
                                <TableCell>{location.quocGia}</TableCell>
                                <TableCell>{location.tinhThanh}</TableCell>
                                <TableCell>
                                    <Box>
