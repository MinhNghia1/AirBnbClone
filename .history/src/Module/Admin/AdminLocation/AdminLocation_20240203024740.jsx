...
export default function AdminLocation() {
  ...
  const handleOnOpen = (locationId) => {
    setIdSelected(locationId);
    if (setIdSelected !== null && setIdSelected !== undefined) {
      setIsOpen(true);
      console.log(setIdSelected,"ID");
    }
  };
            ...
            {(rowsPerPage > 0
              ...
              <StyledTableRow key={location.id}>
                ...
                <StyledTableCell style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                  ...
                  {/* Sử dụng hàm handleOpenModal để mở ModalEditImage */}
                  <Button
                    variant="contained"
                    color="primary"
                    style={{ marginLeft: "10px" }}
                    onClick={() => {
                      handleOnOpen(location.id);
                    }}
                  >
                    Chỉnh sửa
                  </Button>
