...
export default function AdminLocation() {
  ...
  const [selectedLocationId, setSelectedLocationId] = useState(nll);
  ...
  const handleOpenModal = (locationId) => {
    setIsOpen(true);
    setSelectedLocationId(locationId);
    console.log(selectedLocationId, "IDDD");
  };
              ...
              <StyledTableRow key={location.id}>
                ...
                <StyledTableCell style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                  ...
                  <Button
                    ...
                    onClick={() => handleOpenModal(location.id)}
                  >
                    Chỉnh sửa
                  </Button>
                </StyledTableCell>
