...
import { getLocationById } from "../../Apis/viTri";
    ...
    <div className={styled("roomDetail")}>
      <Container>
        ...
        <Grid container>
          ...
          <Grid item md={4}>
            <BookingRoom roomId={roomId} price={price} averageRating={totalReviews === 0 ? 0 :averageRating } totalReviews={totalReviews}   style={{ display: 'flex', justifyContent: 'center' }}></BookingRoom> />
          </Grid>
        </Grid>
