...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      const startDateMatch = dayjs(selectionRange.startDate).isAfter(dayjs(booking.ngayDen)) && dayjs(selectionRange.startDate).isBefore(dayjs(booking.ngayDi));
      const endDateMatch = dayjs(selectionRange.endDate).isAfter(dayjs(booking.ngayDen)) && dayjs(selectionRange.endDate).isBefore(dayjs(booking.ngayDi));
