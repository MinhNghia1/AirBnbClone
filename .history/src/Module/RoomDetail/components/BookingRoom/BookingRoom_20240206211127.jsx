...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      const startDateMatch = dayjs(selectionRange.startDate).isSame(dayjs(booking.ngayDen), 'day');
      const endDateMatch = dayjs(selectionRange.endDate).isSame(dayjs(booking.ngayDi), 'day');
