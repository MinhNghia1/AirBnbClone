...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      ...
      const isOverlap =
        selectionStartDate.isBetween(bookingStartDate, bookingEndDate, null, "[)") ||
        selectionEndDate.isBetween(bookingStartDate, bookingEndDate, null, "(]") ||
        bookingStartDate.isBetween(selectionStartDate, selectionEndDate, null, "[]") ||
        bookingEndDate.isBetween(selectionStartDate, selectionEndDate, null, "[]");
