...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      ...
      const isSelectionWithinBookingRange = selectionStartDate.isSameOrAfter(bookingStartDate) && selectionStartDate.isSameOrBefore(bookingEndDate);
      const isSelectionEndWithinBookingRange = selectionEndDate.isSameOrAfter(bookingStartDate) && selectionEndDate.isSameOrBefore(bookingEndDate);
  
      const isBookingWithinSelectionRange = bookingStartDate.isSameOrAfter(selectionStartDate) && bookingStartDate.isSameOrBefore(selectionEndDate);
      const isBookingEndWithinSelectionRange = bookingEndDate.isSameOrAfter(selectionStartDate) && bookingEndDate.isSameOrBefore(selectionEndDate);
  
      const isBookingStartBeforeSelectionStart = bookingStartDate.isBefore(selectionStartDate);
      const isBookingEndAfterSelectionEnd = bookingEndDate.isAfter(selectionEndDate);
