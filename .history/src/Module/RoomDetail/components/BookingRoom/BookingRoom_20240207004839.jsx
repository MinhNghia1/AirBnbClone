...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      ...
      const isOverlap =
        selectionStartDate.isSameOrAfter(bookingStartDate, 'day') &&
        selectionStartDate.isBefore(bookingEndDate, 'day') ||
        selectionEndDate.isAfter(bookingStartDate, 'day') &&
        selectionEndDate.isSameOrBefore(bookingEndDate, 'day') ||
        bookingStartDate.isSameOrAfter(selectionStartDate, 'day') &&
        bookingStartDate.isBefore(selectionEndDate, 'day') ||
        bookingEndDate.isAfter(selectionStartDate, 'day') &&
        bookingEndDate.isSameOrBefore(selectionEndDate, 'day');
