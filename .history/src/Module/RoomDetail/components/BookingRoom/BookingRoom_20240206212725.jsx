...
export default function BookingRoom({
  ...
  const isBookingValid = () => {
    const isRoomAlreadyBooked = ListOfRoomIsBooked.some((booking) => {
      ...
      const isSelectionWithinBookingRange = selectionStartDate.isBetween(bookingStartDate, bookingEndDate, null, '[]');
      const isSelectionEndWithinBookingRange = selectionEndDate.isBetween(bookingStartDate, bookingEndDate, null, '[]');
  
      const isBookingWithinSelectionRange = bookingStartDate.isBetween(selectionStartDate, selectionEndDate, null, '[]');
      const isBookingEndWithinSelectionRange = bookingEndDate.isBetween(selectionStartDate, selectionEndDate, null, '[]');
