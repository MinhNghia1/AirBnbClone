          ...
          <Grid key={index} item md={6} sx={{ marginBottom: "50px" }}>
            <div className={styled.feedbackItem}>
              <img
                ...
                width={50}
                height={50}
                src={feedback.avatar || "https://scontent.fsgn5-9.fna.fbcdn.net/v/t39.30808-6/367432832_3499400823662075_1915951950605941066_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=a248ae&_nc_eui2=AeHkVx8hxlLpOG5RI60Zh_HXWo8rw3epKOJajyvDd6ko4ootek2DiZwfrROrKf7_3lqrweD-e0cEJsDho-bUV8oS&_nc_ohc=tOUVVbMXL94AX8jNm4b&_nc_ht=scontent.fsgn5-9.fna&oh=00_AfDSjVv0eG86knrgZhLCzGZfEz2yfAGvqTxi0XkzUYql4g&oe=65B9F2DA"}
                alt=""
              />
